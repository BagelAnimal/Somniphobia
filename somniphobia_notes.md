...
- Start (flat platform to be surrounded with test case options)
- Step Tests (small platforms of varying heights)
- Jump Tests (blocks of varying heights)
- Long Jump Tests (blocks of varying distances)
